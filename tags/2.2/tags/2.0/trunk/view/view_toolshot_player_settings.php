        ...
        <div id="col-left" style="width:33%;">
            <div class="embed-responsive embed-responsive-16by9">
                ...
                if($toolshot_player['player'] == 'toolshot'){
                    $tmp = '';
                    foreach($toolshot_player as $key => $val) if($key=='ads_code' || $key=='source_player' || $key=='search_upload'){}else $tmp .= $key.'='.$val.'&'; ?>
                ...
                ?>
                    ...
                    <script type="text/javascript">
                        var toolshot_player = {
                            <?php foreach($toolshot_player as $key => $val) if($key=='ads_code' || $key=='source_player' || $key=='search_upload'){}else echo "\n".$key." : '".$val."',";?>
                        };
