    ...
    <div id="col-container" class="wp-clearfix">
        ...
        <div id="col-left" style="width:33%;">
            <div class="embed-responsive embed-responsive-16by9">
                ...
                <?php }else{?>
                    ...
                    <script type="text/javascript">
                        var toolshot_player = {
                            <?php foreach($toolshot_player as $key => $val) if($key=='ads_code' || $key=='source_player'){}else echo "\n".$key." : '".$val."',";?>
                        };
            ...
            <div class="col-wrap">
                ...
                <p>
                    <a href="<?=get_site_url()?>/wp-admin/post-new.php#metabox_toolshot_player">List server support</a>
                </p>
                <!--<div class="donate_">
                    <hr>
...
<script>
    ...
    $.get('<?=$url_toolshot?>api/get_license', function(data){
        ...
        if(data['p_type']=='Not set'){
            $('.license_').append('<p><b>Type : </b>'+data['p_type']+'</p><p><a href="<?=$url_toolshot?>" target="_blank" style="text-decoration:none;">Buy VIP $5/month</a></p>');
        }else{
            if(data['p_type']=='Vip')
